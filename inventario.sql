...
INSERT INTO `inventario` VALUES (1,5,'oz',5,'2023-11-28'),(2,5,'oz',5,'2023-11-28'),(3,4,'Lt',5,'2023-12-14'),(4,5,'Gr',2323,'2023-12-14'),(5,12,'Kg',78,'2023-12-14'),(6,14,'Lt',21,'2023-12-14'),(7,85,'Pz',232,'2023-12-14');
...
INSERT INTO `log_productos` VALUES (NULL,'Tortillas',NULL,14,'INSERTAR','ANTES','root@localhost','2023-01-01 01:42:34',NULL),(NULL,'Tortillas',NULL,14,'INSERTAR','DESPUES','root@localhost','2023-01-01 01:42:34',NULL),('claro que si','nuevamente',213123,12311,'ACTUALIZAR','DESPUES','root@localhost','2023-12-13 15:02:44',239),(NULL,'chocolate',NULL,450,'INSERTAR','DESPUES','root@localhost','2023-12-13 15:10:59',241),(NULL,'probando',NULL,123,'INSERTAR','ANTES','root@localhost','2023-12-13 15:25:17',0),(NULL,'control',NULL,250,'INSERTAR','ANTES','root@localhost','2023-12-13 15:32:30',0),('control','vaso de vidrio',250,12,'ACTUALIZAR','DESPUES','root@localhost','2023-12-13 15:36:04',247),(NULL,'nuevito',NULL,123,'INSERTAR','DESPUES','root@localhost','2023-12-13 22:22:31',248),(NULL,'yas',NULL,12,'INSERTAR','DESPUES','root@localhost','2023-12-14 01:19:29',249);
...
CREATE TABLE `productos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) NOT NULL,
  `unidad_de_medida` varchar(2) NOT NULL,
  `costo` double DEFAULT NULL,
  `tipo_de_insumo` varchar(50) DEFAULT NULL,
  `fecha_de_registro` date NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `productos` VALUES (235,'dwa','Pz',1,'Alimento','2023-12-12'),(236,'nuevo','lt',432,'Licor','2023-12-12'),(237,'deberia','Ml',3421,'Licor','2023-12-12'),(238,'funcionar','Ml',2103,'Cocina','2023-12-12'),(239,'nuevamente','Gr',12311,'Bebida','2023-12-12'),(240,'Prueba nueva','Ml',1233,'Bebida','2023-12-13'),(241,'chocolate','Kg',450,'Alimento','2023-12-13');
...
INSERT INTO `receta` VALUES (1,'Agua de limon',38),(2,'Agua de horchata',38),(3,'Agua de naranja',38),(4,'Agua de tamarindo',38),(5,'Agua de mango',38),(6,'Agua de maracuyá',38),(7,'Limonada',38),(8,'Limonada de rosas',40),(9,'Limonada de vainilla',40),(10,'Naranjada',38),(11,'Jarra de agua limÃ³n',95),(12,'Jarra de agua naranja',95),(13,'Jarra de agua horchata',95),(14,'Jarra de agua guanabana',95),(15,'Jarra de agua tamarindo',95),(16,'Jarra de agua mango',95),(17,'Jarra de agua maracuyÃ¡',95),(18,'Jarra de naranjada',95),(19,'Jarra de limonada',95),(20,'Jarra de limonada de rosas',95),(21,'Jarra de limonada de vainilla',95),(22,'FrappÃ© taro',45),(23,'FrappÃ© matcha',45),(24,'FrappÃ© guamango',45),(25,'FrappÃ© horchata',45),(26,'FrappÃ© yogurt griego',45),(27,'FrappÃ© tamarindo',45),(28,'FrappÃ© limÃ³n',45),(29,'Frapuccino',45),(30,'FrappÃ© moka',45),(31,'CafÃ© americano',38),(32,'Latte',40),(33,'Latte de vainilla',45),(34,'Latte de avellana',45),(35,'Capuccino chico',45),(36,'Capuccino grande',50),(37,'Base de suero',20),(45,'Mezcal espadÃ­n',65),(46,'Mezcalina de tamarindo',60),(47,'Mezcalina de maracuyÃ¡',65),(48,'Mezcalina de fresa',65),(49,'Mezcalina de fresa con tamarindo',68),(50,'Mezcalina de pepino con albahaca',60),(51,'Mezcalina de jamaica',65),(52,'Carajo oaxaqueÃ±o',65),(53,'Mojito de mezcal',60),(54,'Mojito tradicional',60),(55,'Moctel tropical',45),(56,'Moctel cÃ­trico',45),(57,'Moctel fresca pasiÃ³n',45),(58,'Cafe refill',25),(59,'Latte de soya',45),(60,'Latte de soya con vainilla',50),(61,'Latte de soya con avellana',50),(62,'Malteada de chocolate',50),(63,'Malteada de cookies and cream',50),(64,'Malteada de fresa',50),(65,'Malteada de vainilla',50),(66,'Jugo de naranja',40),(67,'Jugo de naranja grande',80),(68,'Jugo verde',40),(69,'Jugo de naranja con fresa chico',45),(70,'Jugo de naranja con fresa grande',75),(71,'Jugo de naranja con papaya chico',45),(72,'Jugo de naranja con papaya grande',75),(73,'Jugo de naranja con zanahoria chico',45),(74,'Jugo de naranja con zanahoria grande',75),(75,'TÃ© de manzanilla',25),(76,'TÃ© de poleo',25),(77,'TÃ© de menta',25),(78,'TÃ© de hierbabuena',25),(79,'Taro caliente',45),(80,'Matcha caliente',45),(81,'Chai caliente',45),(82,'Soda italiana kiwi',45),(83,'Soda italiana granada',45),(84,'Soda italiana frutos rojos',45),(85,'Soda italiana maracuyÃ¡',45),(86,'Chocolate de agua',35),(87,'Chocolate de leche',40),(88,'Fruta de temporada',85),(89,'Waffles vainilla',80),(90,'Waffles cacao',80),(91,'Hotcakes vainilla',80),(92,'Hotcakes cacao',80),(93,'Torrejas mestizaje',85),(94,'Torrejas rellenas',95),(95,'Memelas con queso',50),(96,'Memelas con quesillo',50),(97,'Memelas con tasajo',65),(98,'Memelas con cecina',65),(99,'Memelas con chorizo',65),(100,'Memelas con carne mixta',65),(101,'Quesadillas fritas con tasajo',65),(102,'Quesadillas fritas con chorizo',65),(103,'Quesadillas fritas con cecina',65),(104,'Quesadillas fritas mixtas',65),(105,'Quesadillas fritas con queso',65),(106,'Quesadillas fritas con quesillo',65),(107,'Enfrijoladas con tasajo',85),(108,'Enfrijoladas con cecina',85),(109,'Enfrijoladas con chorizo',85),(110,'Enfrijoladas sencillas',70),(111,'Entomatadas sencillas',70),(112,'Entomatadas con tasajo',85),(113,'Entomatadas con cecina',85),(114,'Entomatadas con chorizo',85),(115,'Enmoladas sencillas',75),(116,'Enmoladas con tasajo',85),(117,'Enmoladas con cecina',85),(118,'Enmoladas con chorizo',85),(119,'Chilaquiles de huajillo sencillas',80),(120,'Chilaquiles de huajillo con tasajo',90),(121,'Chilaquiles de huajillo con cecina',90),(122,'Chilaquiles de huajillo con chorizo',90),(123,'Chilaquiles de frijol sencillas',75),(124,'Chilaquiles de frijol con tasajo',85),(125,'Chilaquiles de frijol con cecina',85),(126,'Chilaquiles de frijol con chorizo',85),(127,'Chilaquiles verdes sencillas',75),(128,'Chilaquiles verdes con tasajo',85),(129,'Chilaquiles verdes con cecina',85),(130,'Chilaquiles verdes con chorizo',85),(131,'Omelet de espinacas',70),(132,'Omelet de carnes frÃ­as',80),(133,'Omelet alebrije',80),(134,'Omelet chorizo',80),(135,'Omelet primavera',80),(136,'Huevos tarascos',78),(137,'Huevos motuleÃ±osa',78),(138,'Huevos con chorizo',78),(139,'Huevos con jamÃ³n',78),(140,'Huevos con salchicha',78),(141,'Huevos a la mexicana',78),(142,'Huevos rancheros',78),(143,'Negritos',85),(144,'Enchiladas verdes',85),(145,'Enchiladas verdes rellenas de quesillo',95),(146,'Enchiladas verdes rellenas de tasajo',105),(147,'Burrito relleno huevo c/jamÃ³n',90),(148,'Burrito relleno huevo c/chorizo',90),(149,'Burrito relleno huevo c/salchicha',90),(150,'Molletes de chorizo',80),(151,'Molletes de tasajo',85),(152,'Pizza de 3 quesos',1),(153,'Pizza margarita',1),(154,'Pizza de chorizo',1),(155,'Pizza de carnes frÃ­as',1),(156,'Pizza de chapulines',1),(157,'Hamburguesa alebrije',1),(158,'Hamburguesa arrachera',1),(159,'Hamburguesa pollo',1),(160,'Hamburguesa bbq',1),(161,'Hamburguesa oaxaqueÃ±a',1),(162,'Club sandwich',90),(163,'Ciabatta de 3 quesos',85),(164,'Ciabatta de carnes frÃ­as',88),(165,'Ciabatta de tasajo',88),(166,'Ciabatta de jamÃ³n y queso',80),(167,'Quesadillas mestizaje c/tasajo',90),(168,'Quesadillas mestizaje c/cecina',90),(169,'Quesadillas mestizaje c/chorizo',90),(170,'Quesadillas mestizaje c/arrachera',90),(171,'Sopa azteca',60),(172,'Sopa de frijol',60),(173,'Tasajo asado c/ensalada',90),(174,'Tasajo asado c/papas',90),(175,'Cecina enchilada c/ensalada',90),(176,'Cecina enchilada c/papas',90),(177,'Clayuda original',45),(178,'Clayuda mestizaje c/tasajo',75),(179,'Clayuda mestizaje c/cecina',75),(180,'Clayuda mestizaje c/chorizo',75),(181,'Clayuda mestizaje c/arrachera',85),(182,'Clayuda mestizaje sencilla',75),(183,'Torta oaxaqueÃ±a sencilla',1),(184,'Torta oaxaqueÃ±a c/tasajo',1),(185,'Torta oaxaqueÃ±a c/cecina',1),(186,'Torta oaxaqueÃ±a c/chorizo',1),(187,'Costra rellena de tasajo',1),(188,'Costra rellena de cecina',1),(189,'Costra rellena de chorizo',1),(190,'Ensalada del huerto',75),(191,'Ensalada alebrije',75),(192,'Ensalada mestizaje',75),(193,'Pan de caja',1),(194,'Pan de ciabatta',1),(195,'Pan de hamburguesa',1),(196,'Masa para pizza',1),(197,'Pan chocolatÃ­n',1),(198,'Pan concha',1),(199,'Pan orejita',1),(200,'Pan croassant',1),(201,'Pan barquito',1),(202,'Enfrijoladas c/huevo',85),(203,'Entomatadas c/huevo',85),(204,'Enmoladas c/huevo',85),(205,'Chilaquiles de huajillo c/huevo',90),(206,'Chilaquiles de frijol c/huevo',85),(207,'Chilaquiles verdes c/huevo',85),(208,'Chilaquiles rojos c/huevo',85),(209,'Chilaquiles rojos c/tasajo',85),(210,'Chilaquiles rojos c/cecina',85),(211,'Chilaquiles rojos c/chorizo',85),(212,'Chilaquiles rojos sencillos',75),(213,'Chilaquiles rojos c/pollo',85),(214,'Enfrijoladas c/pollo',85),(215,'Entomatadas c/pollo',85),(216,'Enmoladas c/pollo',85),(217,'Chilaquiles de huajillo c/pollo',90),(218,'Chilaquiles de frijol c/pollo',85),(219,'Chilaquiles verdes c/pollo',85),(221,'probando',85),(222,'prueb recet',78),(224,'chiqui',122),(225,'dad',1212);
...
INSERT INTO `usuarios` VALUES (1,'Isaac','100710'),(2,'inventario','231219');
...
-- Dump completed on 2023-12-14 21:19:03
